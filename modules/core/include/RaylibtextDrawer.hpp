...
public:
    ...
    void DrawTextPro(Font font, const char* text, Vector2 position, Vector2 origin, float rotation, float fontSize, float spacing, Color tint) override;

    // Implement DrawTextCodepoint using Raylib's DrawTextCodepoint function
    void DrawTextCodepoint(Font font, int codepoint, Vector2 position, float fontSize, Color tint) override;

    // Implement DrawTextCodepoints using Raylib's DrawTextCodepoints function
    void DrawTextCodepoints(Font font, const int* codepoints, int codepointCount, Vector2 position, float fontSize, float spacing, Color tint) override;
};
