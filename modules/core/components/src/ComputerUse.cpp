...
void ComputerUse::GetMousePosition(void){

};
void ComputerUse::KeyboardType(void){

};
void ComputerUse::Mouseclick(void){

};
void ComputerUse::Respond(void){
