...
namespace graphics
{
    ...
    Triangle::Triangle(const Coordinates2D &point1, const Coordinates2D &point2, const Coordinates2D &point3, const graphics::Color &color)
    ...
    graphics::Color Triangle::GetColor() const
    {
        return mColor;
    }
    ...
    void Triangle::Draw()
    {
        ...
        raylib::DrawTriangle(v1, v2, v3, graphics::toRaylibColor(mColor));
    }
